    ...
    return (
        <div className="signup">
            <div className="card">
                ...
                <button className="btn waves-effect waves-light" type="submit" name="action" onClick={()=> submitData()}>Sign Up
                
                </button>
                <div className="card__footer">
                <Link to="/login" style={{color:"blue"}}>Already a member ? Login</Link>
                </div>
