...
const Post = () => {
    ...
    return (
        <div className="post">
            ...
            style ={{maxWidth:"450px",textAlign:"center",padding:"16px"}}>
                ...
                <button className="btn waves-effect waves-light #ED4C67 pink darken-1" type="submit" name="action" onClick={() => postDetails()}>
                    Post
